...
class GithubPushTool(Tool):    
    ...
    def execute(self, base_branch: str, commit_message: str, file_path: List[str], repo_name: str, repo_owner: str, branch_name: Optional[str] = None) -> str:
        try:
            result = self._run(base_branch, commit_message, file_path, repo_name, repo_owner, branch_name)
            return result
        except Exception as e:
            return f"[ERROR] Tool crashed: {str(e)}"

    def _run(self, base_branch : str, commit_message : str, file_path : List[str], repo_name:str, repo_owner:str, branch_name = None) -> str:
        ...
        try:
            ...
            if branch_name is None:
                ...
                head_branch = "feat:-Add-20250626-1511"
